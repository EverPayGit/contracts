...
// It’s in a dark room, where the walls are blue, it runs from a ghost that roams the halls and haunts it all the time. - line 663
...
//  It spends most of its day eating white, but when it’s quick enough, it gets to eat fruit and sometimes some blue things. - line 186
...
contract EverPay is ERC20Detailed, Ownable, WhitelistedRole {
    ...
    uint256 public rewardYield = 20000;
    uint256 public rewardYieldDenominator = 100000000;
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 10 * 10**7 * 10**DECIMALS;
    ...
    address public treasuryReceiver = 0x95D46852bC48ffd4111a5D948Df8F1e2aDfA5B74;
    address public riskFreeValueReceiver = 0x95D46852bC48ffd4111a5D948Df8F1e2aDfA5B74;
    ...
    constructor() ERC20Detailed("EverPay", "EverPay", uint8(DECIMALS)) {
...
// No more clues, complete the riddle and head to the hidden page.
// Refrence the criteria
// Good Luck.
